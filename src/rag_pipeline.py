...
class RAGPipeline:
    ...
    def __init__(
        ...
        Args:
            ...
            default_k: Default number of top chunks to retrieve.
            score_threshold: Default minimum similarity threshold.
            model_name: Default LLM completion model name.
            use_api: Whether to invoke live API calls.
        """
        load_dotenv()
