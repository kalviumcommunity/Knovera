...
class GroundedGenerator:
    ...
    def generate_answer(
        ...
        """Convenience method to generate answer from query and string context."""
        chunk_dict = {"text": context, "source": "context"}
        res = self.generate_grounded(question=query, retrieved_chunks=[chunk_dict])
        return res.get("answer", "")


# Alias for compatibility
GroundedAnswerGenerator = GroundedGenerator
